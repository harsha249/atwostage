            ...
            <tr> 
                <td colspan="2" align="center"><font size="2"><b> 
                  ...
                  <div id="tmeplatemo_content">  <td colspan="4" align="center">
                     ...
                     <td align="center"><font color="#110022"><strong>Function</strong></font></td>
                     <td align="center"><font color="#110022"><strong>Date of Creation</strong></font></td>
                     <td align="center"><font color="#110022">Event Name</strong></font></td>
                   ...
                   <%
                    Connection con=null;
                       ...
                       con=databasecon.getconnection();
                        ...
                        {
                          n=rs.getString("name");
                          p=rs.getString("choose");
                          r=rs.getString("regstered");
                          g=rs.getString("eventname");
                                      %>
                        <tr>
                            <tr bgcolor="#e0e0e0">
