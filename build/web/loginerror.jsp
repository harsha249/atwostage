...
<!-- Header -->
  <div id="hdr" style="margin:0 auto;"> 
    ...
    <div style="margin-top:-130px;padding-right:30px;width:500px;float:right;"> 
      <form id="login_form" action="jsp/loginchk.jsp" method="post" onsubmit="">
        <table cellspacing="0">
          <tr> 
            <td class="html7magic"><label for="uname1" style="color:#FF0;font-size:16px">User 
              name</label></td>
            <td class="html7magic"><label for="pass1" style="color:#FF0;font-size:16px">Password</label></td>
          </tr>
          <tr>
            <td><input type="text" class="inputtext" name="uname1" id="uname1" value="" tabindex="1" /></td>
        ...
        <span style="color:#F30;font-size:16px;"> ** Username/Password Wrong...Please 
        try again....</span> 
      </form>
    </div>
  </div>
...
<div class="content ">
           ...
           <div style="float:left;width:400px;height:auto;margin:0 auto;padding-top:20px;margin-left:50px;float:left" >
             ...
             <u></u>        </p>          
              ...
              <div class="main_form"  >
                ...
                <div class="control-group">
                   ...
                   <div class="control-group">
       					<label class="control-label">Re-Password&nbsp;<font color="#FF0000">*</font></label>
       					<div class="controls">
       						<input type="password" name="repass" id="repass" class="span6" />
       					</div>
       				</div>
                	  ...
                	  <div id="date1" class="datefield">
       				...
       				<div class="control-group">
       					...
       					<button class="btn btn-primary" type="submit" name="send" id="send">Register Now</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
