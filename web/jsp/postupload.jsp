...
ArrayList list = new ArrayList();
	...
	while (files.hasMoreElements()) 
	{
		...
		if(paramname != null)
		{
	        ...
	        FileInputStream fs1 = null;String label="sensitive";
		...
		String cur_date=(String)session.getAttribute("sysdate");			
			...
			PreparedStatement ps=con.prepareStatement("insert into post(uname,post,cur_date,label) values(?,?,?,?)");
				
                      ps.setString(1,uname);ps.setString(3,cur_date);ps.setString(4,label);
