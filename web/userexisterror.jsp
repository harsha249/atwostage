  ...
  <div id="hdr" style="margin:0 auto;"> 
    ...
    <div style="margin-top:-130px;padding-right:30px;width:500px;float:right;"> 
      <form id="login_form" action="jsp/loginchk.jsp" method="post" onsubmit="">
        <table cellspacing="0">
          <tr> 
            <td class="html7magic"><label for="uname1" style="color:#FF0dd0;font-size:16px">User 
              name</label></td>
            <td class="html7magic"><label for="pass1" style="color:#FF0dd0;font-size:16px">Password</label></td>
          </tr>
          <tr>
...
<div class="content ">
      ...
      <p style="font-size:24px;font-family:Tahoma, Geneva,sans-serif;line-height:1em;text-align:justify;margin-right:300px;float:right;color:#CF6">
            <span style="color:#F30;font-size:16px;">
 	** Event Name is Already Exist...Please try another name </span>            </p>          
